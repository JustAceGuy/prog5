...
public class InputHandler {
    ...
    public static String stringInput(String varName, Validator<String> v) {
        String ret;
    ...
    public static Integer intInput(String varName, Validator<Integer> v) {
    ...
    public static Long longInput(String varName, Validator<Long> v) {
    ...
    public static Float floatInput(String varName, Validator<Float> v) {
